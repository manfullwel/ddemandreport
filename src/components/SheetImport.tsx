...
export const SheetImport = ({ onDataImported, onRawDataImported }: SheetImportProps) => {
    ...
    return (
        <>
            {showGoogleSetup && !isConfigured && (
                <GoogleSheetsWizard onComplete={handleAuthComplete} />
            )}
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Escolha como deseja importar seus dados para análise
                    </CardDescription>
                </CardHeader>
                <CardContent>
                            ...
                            {!isConfigured ? (
                                <div className="text-center space-y-4 py-4">
                                    <p className="text-sm text-muted-foreground">
                                        Para importar do Google Sheets, você precisa primeiro
