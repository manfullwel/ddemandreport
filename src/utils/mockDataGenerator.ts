...
const generateEmployeeName = () => {
    const firstNames = [
        ...
        'Lucas', 'Gabriel', 'Rafael', 'Daniel', 'Bruno', 'Fernando', 'Ricardo',
        'Rodrigo', 'Marcelo', 'André', 'Felipe', 'Eduardo'
    ];
...
const generateClientName = () => {
    const firstNames = [
        'Miguel', 'Arthur', 'Bernardo', 'Heitor', 'Davi', 'Lorenzo', 'Théo',
        'Pedro', 'Gabriel', 'Enzo', 'Matheus', 'Lucas', 'Benjamin', 'Nicolas',
        'Guilherme', 'Rafael', 'Joaquim', 'Samuel', 'Enzo', 'João'
    ];
    
    const lastNames = [
        'Moreira', 'Cardoso', 'Dias', 'Castro', 'Campos', 'Rocha', 'Mendes',
        'Franco', 'Melo', 'Pinto', 'Andrade', 'Barros', 'Freitas', 'Correia',
        'Teixeira', 'Medeiros', 'Reis', 'Siqueira', 'Neves', 'Ramos'
    ];
